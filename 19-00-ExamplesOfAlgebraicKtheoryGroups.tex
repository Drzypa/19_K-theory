...
\usepackage{pmmeta}
\pmcanonicalname{ExamplesOfAlgebraicKtheoryGroups}
\pmcreated{2013-03-22 13:31:35}
\pmmodified{2013-03-22 13:31:35}
\pmowner{mhale}{572}
\pmmodifier{mhale}{572}
\pmtitle{examples of algebraic K-theory groups}
\pmrecord{7}{34118}
\pmprivacy{1}
\pmauthor{mhale}{572}
\pmtype{Example}
...
\hline
$R$ & $K_0(R)$ & $K_1(R)$ & $K_2(R)$ & $K_3(R)$ & $K_4(R)$ \\
\hline
$\Zset$ & $\Zset$ & $\Zset/2$ & $\Zset/2$ & $\Zset/48$ & 0 \\
$\Rset$ & $\Zset$ & $\Rset^\times$ & & & \\
$\Cset$ & $\Zset$ & $\Cset^\times$ & & & \\
\hline
\end{tabular}
